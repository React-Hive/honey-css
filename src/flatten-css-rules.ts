import type { HoneyCssAstNode, HoneyCssAstRuleNode, HoneyCssAstStylesheetNode } from './types';
...
const flattenNodes = (nodes: HoneyCssAstNode[], parentSelector?: string): HoneyCssAstNode[] => {
  ...
  const flushDeclarations = () => {
    ...
    result.push({
      ...
      // Clone buffered declarations because the buffer is reused after flushing
